...
<body style="background: linear-gradient(#036771,#026979,#826b49);">
...
<div id="ogretmen" class="tabcontent">
  <div style="
	...
	<tr><td>Şifre</td><td><input type="password" name="password" placeholder="Şifrenizi girin." style="font-size:18px;border:#eaeaea;padding:7px;"></input></td></tr>
	<tr><td></td><td><input type="submit" name="loginoretmen" value="Giriş" style="font-size:18px;font-weight:bold;color:#026875;justify-content:center;border:none;padding:8px;background:#dadada;"></input></td></tr>
	</table>
	</form>
</div>
</div>
